      ...
      <div className=" h-full mx-auto border-2 rounded-xl md:p-6 md:w-[80%] w-[95%] ">
        ...
        >
          ...
          <div className="courseInfo text-white flex justify-between flex-row flex-wrap items-center space-y-4 md:space-y-0 space-x-4">
            ...
            <div className="space-x-3">
              <label htmlFor="Year"><span className="text-lg font-bold">Year</span></label>
              <select name="Year" id="Year" className="border-2 text-black rounded-sm outline-none bg-slate-200" required>
            ...
            <div className="space-x-3">
              <label htmlFor="Branch"><span className="text-lg font-bold">Branch:</span></label>
              <select name="Branch" id="Branch" className="border-2 rounded-sm outline-none text-black bg-slate-200" required>
          ...
          <div className="gender text-white flex  flex-wrap items-center ">
            <label htmlFor="Gender"><span className="text-lg font-bold">Gender:</span></label>
          ...
          <div className="numbers text-white flex flex-wrap  space-y-4 md:space-y-0  justify-between items-center ">
            <div className="flex space-x-3 flex-wrap items-center">
              <label htmlFor="PhoneNumber"><span className="text-lg font-bold">Phone Number:</span></label>
              <input
                type="tel"
            ...
            <div className="flex space-x-3 flex-wrap items-center">
              <label htmlFor="Whatsapp-Number"><span className="text-lg font-bold">Whatsapp Number:</span></label>
              <input
                type="tel"
                placeholder="0000000000"
                className="border-2 rounded-sm outline-none text-black bg-slate-200 "
          ...
          <div className="mail text-white flex flex-wrap my-3 items-center space-x-4">
            <label htmlFor="Email"><span className="text-lg font-bold">Email:</span></label>
            <input
              type="email"
              name="Email"
          ...
          <div className="stay text-white flex justify-center items-center space-x-4">
            <label htmlFor="stay"><span className="text-lg font-bold">Hosteller / Day Boarder:</span></label>
